...
PageComponent.propTypes = {
  categoria1: P.string.isRequired,
  categoria2: P.string.isRequired,
  categoria3: P.string.isRequired,
  price1: P.number.isRequired,
  price2: P.number.isRequired,
  price3: P.number.isRequired,
